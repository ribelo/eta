...
module User_id : sig
  ...
  val schema : t Eta_schema.Schema.t
  val value : t -> string
  val equal : t -> t -> bool
end = struct
  type t = string
...
let decode_user json =
  ...
  Eta_schema.Schema.decode_with_policy input_schema
    (fun input ->
      Eta.Effect.map
