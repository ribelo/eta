(** Deterministic generators over {!Capabilities.random}.
    ...
    [Capabilities.random] is a portable token rather than an object capability
    so it can cross OxCaml domain boundaries safely. This follows the
    V-CM-H2-C1 decision: pass explicit random tokens into runtime-owned
    scheduling or application helpers instead of closing over object methods. *)
