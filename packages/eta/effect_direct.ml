...
let run ?island_pool ?blocking_pool runtime effect =
    ...
    | _ ->
        {
          ...
          Runtime_core.island_pool =
            (match island_pool with Some _ as pool -> pool | None -> runtime.Runtime_core.island_pool);
          Runtime_core.blocking_pool =
            (match blocking_pool with Some _ as pool -> pool | None -> runtime.Runtime_core.blocking_pool);
        }
  in
