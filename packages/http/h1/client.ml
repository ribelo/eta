...
let request_on_flow ?(max_response_body_bytes = default_max_response_body_bytes)
  ...
  if max_response_body_bytes < 0 then
    invalid_arg
      "Http.H1.Client.request_on_flow: max_response_body_bytes must be >= 0";
...
let make_pool ?(max_response_body_bytes = default_max_response_body_bytes)
  ...
  if max_response_body_bytes < 0 then
    invalid_arg "Http.H1.Client.make_pool: max_response_body_bytes must be >= 0";
...
let request ?(max_response_body_bytes = default_max_response_body_bytes)
  ...
  if max_response_body_bytes < 0 then
    invalid_arg "Http.H1.Client.request: max_response_body_bytes must be >= 0";
