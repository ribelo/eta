...
Search:
    ...
    rg -n -t ocaml 'Eta_redacted\.|Eta\.(Redacted|Effect|Tracer|Logger|Capabilities|Runtime)|Eta_http\.|Eta_stream\.|Eio\.|Tiktoken' packages/eta-ai
...
<!-- BEGIN DEP_MATCHES -->
- packages/eta-ai/eta_ai.ml:2:type headers = Eta_http.Core.Header.t
- packages/eta-ai/eta_ai.ml:3:type api_key = string Eta_redacted.t
- packages/eta-ai/eta_ai.ml:4:let api_key value = Eta_redacted.make ~label:"api_key" value
- packages/eta-ai/eta_ai.ml:84:  | Http_error of Eta_http.Error.t
- packages/eta-ai/eta_ai.ml:199:  Eta_http.Request.make ~headers
- packages/eta-ai/eta_ai.ml:200:    ~body:(Eta_http.Request.Fixed [ Bytes.of_string raw ])
- packages/eta-ai/eta_ai.ml:204:  Eta_http.Body.Stream.read_all body
...
- packages/eta-ai/eta_ai.ml:213:  Eta_http.request client request
...
- packages/eta-ai/eta_ai.ml:221:           response.Eta_http.Response.status >= 200
...
- packages/eta-ai/eta_ai.ml:236:  body : Eta_http.Body.Stream.t;
- packages/eta-ai/eta_ai.ml:261:  |> Eta.Effect.bind (fun response ->
- packages/eta-ai/eta_ai.ml:263:           response.Eta_http.Response.status >= 200
...
- packages/eta-ai/eta_ai.ml:339:    Eta_http.Body.Stream.discard stream.body
...
- packages/eta-ai/eta_ai.ml:378:      Eta_http.Body.Stream.read stream.body
...
- packages/eta-ai/eta_ai.ml:466:  match Eta_http.Core.Url.parse provider.base_url with
- packages/eta-ai/eta_ai.ml:469:        ("server.address", Eta_http.Core.Url.host url);
- packages/eta-ai/eta_ai.ml:470:        ("server.port", string_of_int (Eta_http.Core.Url.effective_port url));
- packages/eta-ai/eta_ai.ml:491:  | Http_error error -> Eta_http.Error.to_string error
...
- packages/eta-ai/eta_ai.mli:10:type headers = Eta_http.Core.Header.t
- packages/eta-ai/eta_ai.mli:11:type api_key = string Eta_redacted.t
- packages/eta-ai/eta_ai.mli:93:  | Http_error of Eta_http.Error.t
- packages/eta-ai/eta_ai.mli:181:  provider -> api_key -> raw_json -> Eta_http.Request.t
- packages/eta-ai/eta_ai.mli:186:  Eta_http.Client.t ->
- packages/eta-ai/eta_ai.mli:187:  Eta_http.Request.t ->
- packages/eta-ai/eta_ai.mli:188:  (response, ai_error) Eta.Effect.t
- packages/eta-ai/eta_ai.mli:199:  ?max_buffer_bytes:int -> provider -> Eta_http.Body.Stream.t -> stream
- packages/eta-ai/eta_ai.mli:205:  Eta_http.Client.t ->
- packages/eta-ai/eta_ai.mli:206:  Eta_http.Request.t ->
...
- packages/eta-ai/test/test_eta_ai.ml:54:  let rendered = Format.asprintf "%a" Eta_redacted.pp key in
- packages/eta-ai/test/test_eta_ai.ml:75:          Eta_http.Core.Header.of_list
- packages/eta-ai/test/test_eta_ai.ml:77:              ("Authorization", "Bearer " ^ Eta_redacted.value api_key);
- packages/eta-ai/test/test_eta_ai.ml:121:  let headers = provider.auth_headers (Eta_redacted.make "sk-test") in
- packages/eta-ai/test/test_eta_ai.ml:125:    (Option.get (Eta_http.Core.Header.get "authorization" headers));
...
- packages/eta-ai/test/test_eta_ai.ml:377:  | Some release -> Eta_http.Body.Stream.of_bytes ~release (chunk_string value)
- packages/eta-ai/test/test_eta_ai.ml:378:  | None -> Eta_http.Body.Stream.of_bytes (chunk_string value)
...
- packages/eta-ai/test/test_eta_ai.ml:720:      ~attrs:[ ("authorization", "Bearer " ^ Eta_redacted.value key) ]
