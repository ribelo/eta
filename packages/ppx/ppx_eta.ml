  ...
  | Some column ->
      ...
      Some
        (Ast_builder.Default.pexp_apply ~loc
           (sql_ident ~loc "Sql.Schema.references")
           args)
...
let schema_column_expr field =
  ...
  let optional =
    ...
    |> List.filter_map Fun.id
  in
  pexp_apply ~loc (sql_ident ~loc "Sql.Schema.column") optional
...
let projection_constructor ~loc fields =
  ...
  | [ field ] ->
      pexp_apply ~loc (sql_ident ~loc "Sql.Projection.one")
  ...
  | _ ->
      ...
      pexp_apply ~loc
        (sql_ident ~loc ("Sql.Projection.t" ^ string_of_int arity))
        (List.map
...
let all_projection_expr ~loc fields =
  ...
  in
  pexp_apply ~loc (sql_ident ~loc "Sql.Projection.map")
                           ...
                           (module_binding ~loc
                              ...
                              ~expr:
                                (pmod_apply ~loc
                                   (pmod_ident ~loc
                                      (Located.mk ~loc
                                         (longident_of_path "Sql.Table.Make")))
                                   (pmod_structure ~loc
                                      [
                          ...
                          pstr_value ~loc Nonrecursive
                            [
                              value_binding ~loc
                                ...
                                ~expr:
                                  (pexp_apply ~loc
                                     (sql_ident ~loc "Sql.Schema.create_table")
                                     [
