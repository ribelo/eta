...
let encode_chat = Eta_ai_openai_chat.encode
let encode_responses = Eta_ai_openai_responses.encode
let decode_chat = Eta_ai_openai_chat.decode
let decode_responses = Eta_ai_openai_responses.decode
let decode_stream_event = Eta_ai_openai_stream.decode_event
