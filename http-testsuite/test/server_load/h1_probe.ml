(* Standalone Eta HTTP/1.1 server probe for autoresearch.
   Starts the testsuite eta H1 server on a fixed port and runs until killed.
   Usage: h1_probe.exe PORT TEMP_DIR *)
