...
pass xaipkg-3ux0 has '^module Audio : sig$' lib/ai/xai/eta_ai_xai.mli
...
pass xaipkg-6h9t has '^[[:space:]]+module Realtime = Realtime$' lib/ai/xai_eio/eta_ai_xai_eio.mli
pass xaipkg-zj7x has '^[[:space:]]+module Speech_to_text = Streaming_stt$' lib/ai/xai_eio/eta_ai_xai_eio.mli
pass xaipkg-79yf has '^[[:space:]]+module Text_to_speech = Streaming_tts$' lib/ai/xai_eio/eta_ai_xai_eio.mli
pass xaipkg-jm8z lacks 'eta_ai_(openai|anthropic|openrouter|moonshot|kimi)' lib/ai/xai/dune

pass xaisurf-errd has '^[[:space:]]+module (Speech_to_text|Text_to_speech|Voices|Realtime) =' lib/ai/xai/eta_ai_xai.mli
...
pass airealtime-u580 has '^[[:space:]]+module Speech_to_text = Streaming_stt$' lib/ai/xai_eio/eta_ai_xai_eio.mli
pass airealtime-zwge has '^[[:space:]]+module Text_to_speech = Streaming_tts$' lib/ai/xai_eio/eta_ai_xai_eio.mli
pass airealtime-32fe has '^module Responses_ws = Responses_ws$' lib/ai/xai_eio/eta_ai_xai_eio.mli
pass xaistt-afb9 has '^[[:space:]]+module Speech_to_text = Streaming_stt$' lib/ai/xai_eio/eta_ai_xai_eio.mli
pass xaistt-7mqs lacks 'type event = Streaming_tts.event' lib/ai/xai_eio/streaming_stt.mli
pass xaitts-f5w0 has '^[[:space:]]+module Text_to_speech = Streaming_tts$' lib/ai/xai_eio/eta_ai_xai_eio.mli
...
pass xaistt-bbo1 has 'Int64.compare length 500_000_000L > 0' lib/ai/xai/speech_to_text.ml

# Cross-provider audio topology and ownership.
for child in Speech_to_text Text_to_speech Voices Realtime; do
  pass oabridge-0eee has "^[[:space:]]+module ${child}" lib/ai/openai/eta_ai_openai.mli
  pass oabridge-0eee has "^[[:space:]]+module ${child} =" lib/ai/xai/eta_ai_xai.mli
done
pass oabridge-i191 has 'Eta_ai.Audio.Speech_to_text.Provider' lib/ai/xai/speech_to_text.mli
pass oabridge-i191 has 'Eta_ai.Audio.Text_to_speech.Provider' lib/ai/xai/text_to_speech.mli
pass oabridge-zo0u lacks 'eta_ai_openai' lib/ai/xai/dune
