    ...
    Staging.reset
      {
        ...
        rollback_transaction =
          (fun _context -> record events "rollback_transaction");
        clear_computed_nodes =
          (fun _context -> record events "clear_computed_nodes");
        clear_staged_binds =
          (fun _context -> record events "clear_staged_binds");
        clear_pure_disposal_hooks =
          (fun _context -> record events "clear_pure_disposal_hooks");
        clear_timer_refresh_staging =
          (fun _context -> record events "clear_timer_refresh_staging");
      }
  in
    ...
    Staging.commit
      {
        ...
        commit_transaction =
          (fun _context -> record events "commit_transaction");
        commit_timer_refresh =
          (fun _context -> record events "commit_timer_refresh");
        ...
        clear_timer_refresh_staged_timers =
          (fun _context -> record events "clear_timer_refresh_staged_timers");
