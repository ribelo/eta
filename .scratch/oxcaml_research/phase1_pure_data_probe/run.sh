...
out_dir="scratch/oxcaml_research/phase1_pure_data_probe/results"
mkdir -p "$out_dir"
: > "$out_dir/compile.out"
...
compile_fixture() {
  local name="$1"
  local expect="$2"
  local src="scratch/oxcaml_research/phase1_pure_data_probe/$name.ml"
  local src_base="scratch/oxcaml_research/phase1_pure_data_probe/$name"
...
compile_fixture pure_data_parallel_positive pass
compile_fixture portable_function_payload_negative fail
compile_fixture portable_ref_payload_negative fail
compile_fixture sampler_field_escape_negative fail
