...
probe_dir="scratch/oxcaml_research/recovery/r1_thunk_cancel"
...
run_fixture candidate_a_cooperative_only
run_fixture candidate_b_polling_aware
run_fixture candidate_c_interpreter_scoped
