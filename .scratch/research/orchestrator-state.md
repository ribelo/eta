...
- Queue: **retry cause-alignment** (registered at E24's oracle consultation) → E15 (interruptible) → E16 (Reader race) → E21 (resumable probe) → E17 (gated) → E18 (simulation)
  hold-gated)
...
- Last update: 2026-07-23 — E24c promoted
