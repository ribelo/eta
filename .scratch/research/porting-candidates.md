...
Latch (6.2) — rejected in `.scratch/research/journal.md` V-CDv2/V-CDv4.
...
**Already evaluated and rejected** in `.scratch/research/journal.md` V-CDv2: "the candidate is
...
**Explicitly rejected** in `.scratch/research/journal.md` V-CDv4: "Latch saves lines, but it mostly
...
5. **Deferred/Latch (6.1/6.2):** already decided in `.scratch/research/journal.md` (V-CDv2/V-CDv4);
...
`lib/stream/eta_stream.ml`, `.scratch/research/journal.md`, `.reference/effect-smol`, and
