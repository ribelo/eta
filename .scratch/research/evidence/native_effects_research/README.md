...
NATIVE_EFFECTS_NEG=presence_missing_handler nix develop -c dune build .scratch/research/evidence/native_effects_research/neg_presence_missing_handler.exe
NATIVE_EFFECTS_NEG=token_ask_without_scope nix develop -c dune build .scratch/research/evidence/native_effects_research/neg_token_ask_without_scope.exe
```
