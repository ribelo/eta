...
| 5 | Benchmark throughput/latency at-or-better than hand-rolled exporter. | Retained benchmark evidence: `.scratch/research/evidence/bench-results/eta-otel-encoder-repeat-current.json` and `.scratch/research/evidence/bench-results/eta-5zo-quick-current.json`. The E2E same-file local collector comparison was transient scratch output and is not retained in Git. | Partially retained. |
