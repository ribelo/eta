...
- nix develop .#oxcaml -c dune exec .scratch/research/evidence/eta_research/scoped_sessions/p_scoped_4/branch_c_supervised_session.exe
  - Result: PASS, see results/branch_c_supervised_session.log.
- nix develop .#oxcaml -c dune exec .scratch/research/evidence/eta_research/scoped_sessions/p_scoped_4/branch_b_local_wrapper.exe
  - Result: PASS, see results/branch_b_local_wrapper.log.
- nix develop .#oxcaml -c dune build .scratch/research/evidence/eta_research/scoped_sessions/p_scoped_4/negative/child_escape_negative.exe
  - Result: expected compile failure, see results/child_escape_negative.log.
- git apply --check .scratch/research/evidence/eta_research/scoped_sessions/p_scoped_4/ws_client_branch_c.patch
