...
```sh
nix develop -c dune exec .scratch/research/evidence/bench_research/a_custom_baseline.exe -- --quick
nix develop -c bash .scratch/research/evidence/bench_research/compile_time_candidates.sh
```
