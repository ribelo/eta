...
| T13 | Timer catch-up/coalescing | Large clock jumps for `Time.interval`, `Time.after`, `Time.deadline`, `Time.now`, `Time.step`, and `Time.step_coalesced`: no past-reschedule loop, no hidden auto-stabilization, and documented exact replay or coalescing behavior is asserted. | High | Incremental clock tests adapted to Eta timers |
