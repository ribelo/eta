...
- eta-ai should not bury a custom long-lived producer/mailbox bridge to expose
  SSE as Eta_stream.Stream.
- Eta_stream needs a public owned effect-reader stream constructor that runs a
...
- Triggered for eta-stream. A public Eta_stream.Stream source cannot currently
...
- The public eta-ai streaming API should return Eta_stream.Stream only after
