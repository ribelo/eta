...
let () =
  run_one "direct" (fun () -> Stub.hold_lock_cpu 60_000_000);
  run_one "run_in_systhread" (fun () ->
      Eio_unix.run_in_systhread ~label:"hold_lock_cpu" (fun () ->
          Stub.hold_lock_cpu 60_000_000))
