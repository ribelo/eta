...
val connect_session_on_flow :
  ...
  api_key:Eta_ai.api_key ->
  Eta_http.Core.Url.t ->
  Eta_ai_openai.Audio.Realtime.session ->
  (t, realtime_error) Eta.Effect.t

val send_event :
  t ->
  Eta_ai_openai.Audio.Realtime.client_event ->
  (unit, realtime_error) Eta.Effect.t

val events :
  t ->
  (Eta_ai_openai.Audio.Realtime.server_event, realtime_error) Eta_stream.Stream.t

val read_event :
  t ->
  (Eta_ai_openai.Audio.Realtime.server_event option, realtime_error) Eta.Effect.t
...
module Transport : sig
  include
    Eta_ai.Realtime.Transport
      with type session = Eta_ai_openai.Audio.Realtime.session
       and type client_event = Eta_ai_openai.Audio.Realtime.client_event
       and type server_event = Eta_ai_openai.Audio.Realtime.server_event
