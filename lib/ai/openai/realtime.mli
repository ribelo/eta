...
val connect :
  ...
  model:string ->
  unit ->
  (t, Eta_http.Ws.Client.ws_error) Eta.Effect.t

val send_event : t -> client_event -> (unit, realtime_error) Eta.Effect.t
val events : t -> (server_event, Eta_http.Ws.Client.ws_error) Eta_stream.Stream.t
val close : t -> (unit, Eta_http.Ws.Client.ws_error) Eta.Effect.t
