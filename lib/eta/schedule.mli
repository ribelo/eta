...
val both : ('input, 'a) t -> ('input, 'b) t -> ('input, 'a * 'b) t
val either : ('input, 'a) t -> ('input, 'b) t -> ('input, 'a * 'b) t
val and_then :
  ('input, 'left) t ->
  ('input, 'right) t ->
  ('input, ('left, 'right) and_then_output) t
val modify_delay : ('output -> Duration.t -> Duration.t) -> ('input, 'output) t -> ('input, 'output) t
val while_output : ('output -> bool) -> ('input, 'output) t -> ('input, 'output) t
val tap_input : ('input -> unit) -> ('input, 'output) t -> ('input, 'output) t
val tap_output : ('output -> unit) -> ('input, 'output) t -> ('input, 'output) t
val jittered : ?min:float -> ?max:float -> ('input, 'output) t -> ('input, 'output) t
...
val start : ?random:Capabilities.random -> ('input, 'output) t -> ('input, 'output) driver
...
(** Step a schedule with the current runtime clock and input value. *)
