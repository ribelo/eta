...
ETA_H2_BODY_REQUESTS=64 ETA_H2_BODY_REPEATS=1 \
  bash .hill-climbing/h2-body-read-attribution-20260615/measure.sh \
  >/tmp/eta-h2-body-check.out

grep -q '^METRIC h2_body_success=1.000000$' /tmp/eta-h2-body-check.out
